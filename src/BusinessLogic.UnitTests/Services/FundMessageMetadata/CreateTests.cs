...
namespace BusinessLogic.UnitTests.Services.FundMessageMetadata
{
    ...
    public class CreateTests : BaseFundMessageMetadataTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.FundMessageMetadata.Add(It.IsAny<Entities.FundMessageMetadata>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Create(new Entities.FundMessageMetadata());
