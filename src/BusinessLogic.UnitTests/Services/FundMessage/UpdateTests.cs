...
namespace BusinessLogic.UnitTests.Services.FundMessage
{
    ...
    public class UpdateTests : BaseFundMessageTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.FundMessages.Update(It.IsAny<Entities.FundMessage>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Update(new Entities.FundMessage());
