...
namespace BusinessLogic.UnitTests.Services.FundMessage
{
    ...
    public class CreateTests : BaseFundMessageTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.FundMessages.Add(It.IsAny<Entities.FundMessage>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Create(new Entities.FundMessage());
