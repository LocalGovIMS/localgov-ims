...
namespace BusinessLogic.UnitTests.Services.ImportProcessingRule
{
    ...
    public class CreateTests : BaseImportProcessingRuleTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.ImportProcessingRules.Add(It.IsAny<Entities.ImportProcessingRule>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Create(new Entities.ImportProcessingRule());
