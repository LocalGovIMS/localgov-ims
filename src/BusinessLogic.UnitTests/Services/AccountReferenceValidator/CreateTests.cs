...
namespace BusinessLogic.UnitTests.Services.AccountReferenceValidator
{
    ...
    public class CreateTests : BaseAccountReferenceValidatorTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.AccountReferenceValidators.Add(It.IsAny<Entities.AccountReferenceValidator>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Create(new Entities.AccountReferenceValidator());
