...
namespace BusinessLogic.UnitTests.Services.AccountReferenceValidator
{
    ...
    public class UpdateTests : BaseAccountReferenceValidatorTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.AccountReferenceValidators.Update(It.IsAny<Entities.AccountReferenceValidator>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Update(new Entities.AccountReferenceValidator());
