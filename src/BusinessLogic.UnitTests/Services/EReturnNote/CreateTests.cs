...
namespace BusinessLogic.UnitTests.Services.EReturnNote
{
    ...
    public class CreateTests : BaseTest
    {
        ...
        {
            MockUnitOfWork.Setup(x => x.EReturnNotes.Add(It.IsAny<Entities.EReturnNote>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Create(new Entities.EReturnNote());
        ...
        public void CheckPermissions()
        {
            ...
            var roles = new List<string>() { 
                ...
                BusinessLogic.Security.Role.EReturnDelete
            };
