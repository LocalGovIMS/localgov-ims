...
namespace BusinessLogic.UnitTests.Services.AccountHolder
{
    ...
    public class GetByAccountReferenceStringStringTests : BaseAccountHolderTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.AccountHolders.GetByAccountReference(It.IsAny<string>(), It.IsAny<string>()))
