...
namespace BusinessLogic.UnitTests.Services.CheckDigitConfiguration
{
    ...
    public class CreateTests : BaseCheckDigitConfigurationTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.CheckDigitConfigurations.Add(It.IsAny<Entities.CheckDigitConfiguration>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Create(new Entities.CheckDigitConfiguration());
