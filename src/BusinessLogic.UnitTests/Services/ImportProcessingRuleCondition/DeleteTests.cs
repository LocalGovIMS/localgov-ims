...
namespace BusinessLogic.UnitTests.Services.ImportProcessingRuleCondition
{
    ...
    public class DeleteTests : BaseImportProcessingRuleActionTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.ImportProcessingRuleConditions.Get(It.IsAny<int>()))
                .Returns(new Entities.ImportProcessingRuleCondition());

            MockUnitOfWork.Setup(x => x.ImportProcessingRuleConditions.Update(It.IsAny<Entities.ImportProcessingRuleCondition>()));
        }
