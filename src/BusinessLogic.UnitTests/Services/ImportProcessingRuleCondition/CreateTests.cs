...
namespace BusinessLogic.UnitTests.Services.ImportProcessingRuleCondition
{
    ...
    public class CreateTests : BaseImportProcessingRuleActionTest
    {
        ...
        {
            MockUnitOfWork.Setup(x => x.ImportProcessingRuleConditions.Add(It.IsAny<Entities.ImportProcessingRuleCondition>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Create(new Entities.ImportProcessingRuleCondition());
