...
namespace BusinessLogic.UnitTests.Services.Suspense
{
    ...
    public class CreateCreateSuspenseArgsTests : TestBase
    {
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Create(new BusinessLogic.Services.CreateSuspenseArgs() { Suspense = new Entities.Suspense() });
