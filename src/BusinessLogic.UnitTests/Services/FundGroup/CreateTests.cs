...
namespace BusinessLogic.UnitTests.Services.FundGroup
{
    ...
    public class CreateTests : BaseFundGroupTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.FundGroups.Add(It.IsAny<Entities.FundGroup>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Create(new Entities.FundGroup());
