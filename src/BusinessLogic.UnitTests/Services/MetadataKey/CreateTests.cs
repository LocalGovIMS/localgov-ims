...
namespace BusinessLogic.UnitTests.Services.MetadataKey
{
    ...
    public class CreateTests : BaseMetadataKeyTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.MetadataKeys.Add(It.IsAny<Entities.MetadataKey>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Create(new Entities.MetadataKey());
