...
namespace BusinessLogic.UnitTests.Services.MetadataKey
{
    ...
    public class UpdateTests : BaseMetadataKeyTest
    {
        private void SetupUnitOfWork()
        {
            MockUnitOfWork.Setup(x => x.MetadataKeys.Update(It.IsAny<Entities.MetadataKey>()));
        }
        ...
        public void ReturnsCorrectType()
        {
            ...
            // Act
            var result = service.Update(new Entities.MetadataKey());
