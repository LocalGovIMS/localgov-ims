...
namespace BusinessLogic.UnitTests.Services.ImportProcessingRuleAction
{
    ...
    public class DeleteTests : BaseImportProcessingRuleActionTest
    {
        ...
        {
            MockUnitOfWork.Setup(x => x.ImportProcessingRuleActions.Get(It.IsAny<int>()))
                .Returns(new Entities.ImportProcessingRuleAction());

            MockUnitOfWork.Setup(x => x.ImportProcessingRuleActions.Update(It.IsAny<Entities.ImportProcessingRuleAction>()));
        }
