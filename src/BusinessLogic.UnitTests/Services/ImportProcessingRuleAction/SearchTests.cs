...
namespace BusinessLogic.UnitTests.Services.ImportProcessingRuleAction
{
    ...
    public class SearchTests : BaseImportProcessingRuleActionTest
    {
        private void SetupUnitOfWork()
        {
            ...
            MockUnitOfWork.Setup(x => x.ImportProcessingRuleActions.Search(It.IsAny<SearchCriteria>(), out test))
                .Returns(new List<Entities.ImportProcessingRuleAction>()
                    {
                        new Entities.ImportProcessingRuleAction()
                        {
                            Id = 1,
        ...
        public void ReturnsCorrectType()
        {
            ...
            Assert.IsInstanceOfType(result, typeof(SearchResult<Entities.ImportProcessingRuleAction>));
        }
