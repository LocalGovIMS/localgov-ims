...
namespace BusinessLogic.UnitTests.ImportProcessing.ImportProcessor
{
    ...
    public class TestBase
    {
        ...
        protected BusinessLogic.ImportProcessing.ImportProcessor ImportProcessor;
        protected ImportProcessorArgs Args;

        protected void SetupImportProcessor()
        {
            ImportProcessor = new BusinessLogic.ImportProcessing.ImportProcessor(
                MockLogger.Object,
        ...
        protected void SetupImportProcessorArgs()
        {
            Args = new ImportProcessorArgs()
            {
        ...
        protected Entities.Import GetBadImport()
        {
            return new Entities.Import()
            {
                BatchReference = "Batch Reference",
