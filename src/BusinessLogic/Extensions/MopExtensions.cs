...
namespace BusinessLogic.Extensions
{
    public static class MopExtensions
    {
        ...
        private static bool IsA(this Mop item, string key)
        {
            ...
            var metaData = item.Metadata.FirstOrDefault(x => x.MopMetadataKey.Name == key && Convert.ToBoolean(x.Value).Equals(true));
        ...
        public static string GetMopMetadataValue(this Mop item, string key, string defaultValue)
        {
            ...
            return item.Metadata.FirstOrDefault(x => x.MopMetadataKey.Name == key)?.Value ?? defaultValue;
        }
        ...
        public static T GetMopMetadataValue<T>(this Mop item, string key, T defaultValue)
        {
            ...
            return item.Metadata.FirstOrDefault(x => x.MopMetadataKey.Name == key)?.Value == null
                ? defaultValue
                : (T)Convert.ChangeType(item.Metadata.FirstOrDefault(x => x.MopMetadataKey.Name == key)?.Value, typeof(T));
        }
    }
}
