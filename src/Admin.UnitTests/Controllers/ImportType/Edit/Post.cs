...
namespace Admin.UnitTests.Controllers.ImportType.Edit
{
    [TestClass]
    ...
    public class Post
    {
        ...
        {
            var editCommand = new Mock<IModelCommand<Models.ImportType.EditViewModel>>();
            editCommand.Setup(x => x.Execute(It.IsAny<Models.ImportType.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
