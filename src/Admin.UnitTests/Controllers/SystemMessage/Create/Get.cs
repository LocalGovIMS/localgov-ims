...
namespace Admin.UnitTests.Controllers.SystemMessage.Create
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Build()).Returns(new Models.SystemMessage.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Create System Message", namedArgument.TypedValue.Value);
        }
