...
namespace Admin.UnitTests.Controllers.SystemMessage.Edit
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.SystemMessage.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Edit System Message", namedArgument.TypedValue.Value);
        }
