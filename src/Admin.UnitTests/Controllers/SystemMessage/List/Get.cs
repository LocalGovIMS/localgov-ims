...
namespace Admin.UnitTests.Controllers.SystemMessage.List
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        {
            MockListViewModelBuilder.Setup(x => x.Build()).Returns(new List<Models.SystemMessage.DetailsViewModel>());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("System Messages", namedArgument.TypedValue.Value);
        }
        ...
        public void ReturnsCorrectViewModelType()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(List<Models.SystemMessage.DetailsViewModel>));
        }
    }
}
