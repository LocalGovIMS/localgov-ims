...
using DependenciesClass = Admin.Controllers.UserTemplateControllerDependencies;

namespace Admin.UnitTests.Classes.Dependencies
{
    [TestClass]
    [ExcludeFromCodeCoverage]
    public class UserTemplateControllerDependenciesTests
    {
        ...
        [TestMethod]
        public void ThrowsCorrectExceptionDescriptionTypeWhenBaiscListViewModelBuiderIsNull()
        {
            try
            {
                var dependencies = new DependenciesClass(
