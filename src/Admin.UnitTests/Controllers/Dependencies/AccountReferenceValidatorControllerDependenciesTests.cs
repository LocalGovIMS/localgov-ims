...
using DependenciesClass = Admin.Controllers.AccountReferenceValidatorControllerDependencies;

namespace Admin.UnitTests.Controllers
{
    [TestClass]
    [ExcludeFromCodeCoverage]
    public class AccountReferenceValidatorControllerDependenciesTests
    {
