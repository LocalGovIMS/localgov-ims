...
using DependenciesClass = Admin.Controllers.MethodOfPaymentMetadataControllerDependencies;

namespace Admin.UnitTests.Classes.Dependencies
{
    [TestClass]
    [ExcludeFromCodeCoverage]
    public class MethodOfPaymentMetadataControllerDependenciesTests
    {
