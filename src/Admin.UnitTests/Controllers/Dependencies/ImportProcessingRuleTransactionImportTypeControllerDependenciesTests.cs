...
using DependenciesClass = Admin.Controllers.ImportProcessingRuleTransactionImportTypeControllerDependencies;

namespace Admin.UnitTests.Classes.Dependencies
{
    [TestClass]
    [ExcludeFromCodeCoverage]
    public class ImportProcessingRuleTransactionImportTypeControllerDependenciesTests
    {
