...
using DependenciesClass = Admin.Controllers.ImportProcessingRuleConditionControllerDependencies;

namespace Admin.UnitTests.Classes.Dependencies
{
    [TestClass]
    [ExcludeFromCodeCoverage]
    public class ImportProcessingRuleConditionControllerDependenciesTests
    {
