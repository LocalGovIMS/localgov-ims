...
using DependenciesClass = Admin.Controllers.ImportProcessingRuleActionControllerDependencies;

namespace Admin.UnitTests.Classes.Dependencies
{
    [TestClass]
    [ExcludeFromCodeCoverage]
    public class ImportProcessingRuleActionControllerDependenciesTests
    {
