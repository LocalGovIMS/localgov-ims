...
using DependenciesClass = Admin.Controllers.TransactionImportTypeImportProcessingRuleControllerDependencies;

namespace Admin.UnitTests.Classes.Dependencies
{
    [TestClass]
    [ExcludeFromCodeCoverage]
    public class TransactionImportTypeImportProcessingRuleControllerDependenciesTests
    {
