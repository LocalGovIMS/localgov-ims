...
namespace Admin.UnitTests.Controllers.Office.Create
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Rebuild(It.IsAny<Models.Office.EditViewModel>())).Returns(new Models.Office.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Create Office", namedArgument.TypedValue.Value);
        }
