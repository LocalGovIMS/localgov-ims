...
namespace Admin.UnitTests.Controllers.Office.Create
{
    [TestClass]
    ...
    public class Post
    {
        ...
        {
            var createCommand = new Mock<IModelCommand<Models.Office.EditViewModel>>();
            createCommand.Setup(x => x.Execute(It.IsAny<Models.Office.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
