...
using SearchCriteria = Admin.Models.EReturn.SearchCriteria;
using ListViewModel = Admin.Models.EReturn.ListViewModel;

namespace Admin.UnitTests.Controllers.EReturn.Search
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        private ActionResult GetResult()
        {
            ...
            controllerContext.SetupGet(p => p.HttpContext.Session["EReturnController::IsAPaymentSearch"]).Returns(false);
