...
namespace Admin.UnitTests.Controllers.EReturn.Approve
{
    ...
    public class Get : TestBase
    {
        ...
        {
            return GetMethod(typeof(HttpGetAttribute), nameof(Controller.Approve));
        }
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Approve eReturn", namedArgument.TypedValue.Value);
        }
