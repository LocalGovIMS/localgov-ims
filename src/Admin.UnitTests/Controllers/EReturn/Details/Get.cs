...
namespace Admin.UnitTests.Controllers.EReturn.Details
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        {
            MockDetailsViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("eReturn Details", namedArgument.TypedValue.Value);
        }
