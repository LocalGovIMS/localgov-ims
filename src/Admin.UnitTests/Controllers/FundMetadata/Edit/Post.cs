...
namespace Admin.UnitTests.Controllers.FundMetadata.Edit
{
    [TestClass]
    ...
    public class Post : TestBase
    {
        ...
        private ActionResult GetResult(Models.FundMetadata.EditViewModel model, bool isModelValid)
        {
            MockEditCommand.Setup(x => x.Execute(It.IsAny<Models.FundMetadata.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));

            MockEditViewModelBuilder.Setup(x => x.Rebuild(It.IsAny<Models.FundMetadata.EditViewModel>())).Returns(model);
        ...
        {
            var result = GetResult(new Models.FundMetadata.EditViewModel(), false) as ViewResult;
        ...
        public void ReturnsCorrectViewModelTypeIfModelInvalid()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(Models.FundMetadata.EditViewModel));
        }

        [TestMethod]
        public void ReturnsRedirectToRouteResultIfModelValid()
        {
            var result = GetResult(new Models.FundMetadata.EditViewModel(), true);
        ...
        {
            var result = GetResult(new Models.FundMetadata.EditViewModel(), true) as RedirectToRouteResult;
