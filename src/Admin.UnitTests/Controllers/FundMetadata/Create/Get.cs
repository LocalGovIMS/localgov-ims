...
namespace Admin.UnitTests.Controllers.FundMetadata.Create
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockCreateViewModelBuilder.Setup(x => x.Build()).Returns(new Models.FundMetadata.EditViewModel());
            MockCreateViewModelBuilder.Setup(x => x.Build(It.IsAny<CreateViewModelBuilderArgs>())).Returns(new Models.FundMetadata.EditViewModel());
