...
namespace Admin.UnitTests.Controllers.FundMetadata.Create
{
    [TestClass]
    ...
    public class Post : TestBase
    {
        ...
        {
            MockCreateCommand.Setup(x => x.Execute(It.IsAny<Models.FundMetadata.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
