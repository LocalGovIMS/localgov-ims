...
namespace Admin.UnitTests.Controllers.FileImport.Confirm
{
    ...
    public class Get : TestBase
    {
        ...
        {
            return GetMethod(typeof(HttpGetAttribute), nameof(Controller.Confirm));
        }
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Confirm Import", namedArgument.TypedValue.Value);
        }
        ...
        public void ReturnsCorrectViewName()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsTrue(string.IsNullOrEmpty(result.ViewName) || result.ViewName == "Confirm");
        }
        ...
        public void ReturnsCorrectViewModelType()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(Models.Import.ConfirmViewModel));
        }
    }
}
