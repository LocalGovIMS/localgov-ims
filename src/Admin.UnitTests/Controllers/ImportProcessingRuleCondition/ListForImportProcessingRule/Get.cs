...
using ControllerDependencies = Admin.Controllers.ImportProcessingRuleConditionControllerDependencies;
using DetailsViewModel = Admin.Models.ImportProcessingRuleCondition.DetailsViewModel;
using EditViewModel = Admin.Models.ImportProcessingRuleCondition.EditViewModel;
using ListViewModel = Admin.Models.ImportProcessingRuleCondition.ListViewModel;
using SearchCriteria = Admin.Models.ImportProcessingRuleCondition.SearchCriteria;

namespace Admin.UnitTests.Controllers.ImportProcessingRuleCondition.ListForImportProcessingRule
{
    [TestClass]
    ...
    public class Get
    {
        ...
        private MethodInfo GetListMethod()
        {
            return _controller.GetMethods()
                .Where(x => x.Name == "_ListForImportProcessingRule")
                .FirstOrDefault();
        }
        ...
        private ActionResult GetTestListResult()
        {
            ...
            return controller._ListForImportProcessingRule(1);
        }
