...
namespace Admin.UnitTests.Controllers.ImportProcessingRuleCondition.ListForImportProcessingRule
{
    ...
    public class Get : TestBase
    {
        ...
        {
            return GetMethod(typeof(ChildActionOnlyAttribute), nameof(Controller._ListForImportProcessingRule));
        }
        ...
        {
            MockListViewModelBuilder.Setup(x => x.Build(It.IsAny<Models.ImportProcessingRuleCondition.SearchCriteria>())).Returns(new Models.ImportProcessingRuleCondition.ListViewModel());
