...
namespace Admin.UnitTests.Controllers.ImportProcessingRuleCondition.Edit
{
    ...
    public class Post : TestBase
    {
        ...
        {
            MockEditCommand.Setup(x => x.Execute(It.IsAny<Models.ImportProcessingRuleCondition.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));

            MockEditViewModelBuilder.Setup(x => x.Rebuild(It.IsAny<Models.ImportProcessingRuleCondition.EditViewModel>())).Returns(model);
