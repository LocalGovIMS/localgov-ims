...
namespace Admin.UnitTests.Controllers.ImportProcessingRuleCondition.Create
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockCreateViewModelBuilder.Setup(x => x.Build()).Returns(new Models.ImportProcessingRuleCondition.EditViewModel());
            MockCreateViewModelBuilder.Setup(x => x.Build(It.IsAny<CreateViewModelBuilderArgs>())).Returns(new Models.ImportProcessingRuleCondition.EditViewModel());
