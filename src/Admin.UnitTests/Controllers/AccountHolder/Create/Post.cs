...
namespace Admin.UnitTests.Controllers.AccountHolder.Create
{
    ...
    public class Post
    {
        ...
        {
            var createCommand = new Mock<IModelCommand<Models.AccountHolder.EditViewModel>>();
            createCommand.Setup(x => x.Execute(It.IsAny<Models.AccountHolder.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
