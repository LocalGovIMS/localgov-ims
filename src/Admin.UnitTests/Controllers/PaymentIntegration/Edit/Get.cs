...
namespace Admin.UnitTests.Controllers.PaymentIntegration.Edit
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.PaymentIntegration.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Edit Payment Integration", namedArgument.TypedValue.Value);
        }
