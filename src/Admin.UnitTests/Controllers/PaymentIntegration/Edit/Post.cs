...
namespace Admin.UnitTests.Controllers.PaymentIntegration.Edit
{
    [TestClass]
    ...
    public class Post
    {
        ...
        {
            var editCommand = new Mock<IModelCommand<Models.PaymentIntegration.EditViewModel>>();
            editCommand.Setup(x => x.Execute(It.IsAny<Models.PaymentIntegration.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
