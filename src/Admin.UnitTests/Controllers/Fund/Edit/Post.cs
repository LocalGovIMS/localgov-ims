...
namespace Admin.UnitTests.Controllers.Fund.Edit
{
    [TestClass]
    ...
    public class Post
    {
        ...
        {
            var editCommand = new Mock<IModelCommand<Models.Fund.EditViewModel>>();
            editCommand.Setup(x => x.Execute(It.IsAny<Models.Fund.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
