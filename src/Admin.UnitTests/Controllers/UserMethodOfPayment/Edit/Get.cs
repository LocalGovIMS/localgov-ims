...
namespace Admin.UnitTests.Controllers.UserMethodOfPayment.Edit
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.UserMethodOfPayment.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Edit Methods of Payment", namedArgument.TypedValue.Value);
        }
