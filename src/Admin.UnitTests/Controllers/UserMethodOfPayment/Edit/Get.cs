...
namespace Admin.UnitTests.Controllers.UserMethodOfPayment.Edit
{
    ...
    public class Get
    {
        ...
        {
            var editViewModelBuilder = new Mock<IModelBuilder<Models.UserMethodOfPayment.EditViewModel, int>>();
            editViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.UserMethodOfPayment.EditViewModel());
