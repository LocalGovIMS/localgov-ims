...
namespace Admin.UnitTests.Controllers.EReturnTemplateRow.Edit
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.EReturnTemplateRow.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Edit eReturn Template Row", namedArgument.TypedValue.Value);
        }
