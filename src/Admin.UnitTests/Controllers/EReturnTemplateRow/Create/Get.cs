...
namespace Admin.UnitTests.Controllers.EReturnTemplateRow.Create
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockCreateViewModelBuilder.Setup(x => x.Build()).Returns(new Models.EReturnTemplateRow.EditViewModel());
            MockCreateViewModelBuilder.Setup(x => x.Build(It.IsAny<CreateViewModelBuilderArgs>())).Returns(new Models.EReturnTemplateRow.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Create eReturn Template Row", namedArgument.TypedValue.Value);
        }
