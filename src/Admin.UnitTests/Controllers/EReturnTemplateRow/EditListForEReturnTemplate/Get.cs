...
namespace Admin.UnitTests.Controllers.EReturnTemplateRow.EditListForEReturnTemplate
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        {
            MockListViewModelBuilder.Setup(x => x.Build(It.IsAny<Models.EReturnTemplateRow.SearchCriteria>())).Returns(new Models.EReturnTemplateRow.ListViewModel());

            return Controller._EditListForEReturnTemplate(1);
        }
