...
namespace Admin.UnitTests.Controllers.Role.Details
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        {
            MockDetailsViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new DetailsViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Role Details", namedArgument.TypedValue.Value);
        }
