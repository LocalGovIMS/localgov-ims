...
namespace Admin.UnitTests.Controllers.MethodOfPayment.Create
{
    [TestClass]
    ...
    public class Post
    {
        ...
        {
            var createCommand = new Mock<IModelCommand<Models.MethodOfPayment.EditViewModel>>();
            createCommand.Setup(x => x.Execute(It.IsAny<Models.MethodOfPayment.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
