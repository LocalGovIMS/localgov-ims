...
namespace Admin.UnitTests.Controllers.ImportProcessingRuleTransactionImportType.Create
{
    [TestClass]
    ...
    public class Get
    {
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Create Transaction Import Type Link", namedArgument.TypedValue.Value);
        }
