...
namespace Admin.UnitTests.Controllers.Home.Unauthorised
{
    [TestClass]
    ...
    public class Get
    {
        ...
        private ActionResult GetResult()
        {
            ...
            return controller.Unauthorised();
        }
        ...
        public void ReturnsCorrectViewName()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsTrue(string.IsNullOrEmpty(result.ViewName) || result.ViewName == "Unauthorised");
        }
    }
}
