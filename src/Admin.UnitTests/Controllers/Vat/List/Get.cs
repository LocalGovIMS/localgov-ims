...
namespace Admin.UnitTests.Controllers.Vat.ListForUser
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("VAT Codes", namedArgument.TypedValue.Value);
        }
        ...
        public void ReturnsCorrectViewModelType()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(List<Models.Vat.DetailsViewModel>));
        }
    }
}
