...
namespace Admin.UnitTests.Controllers.Vat.Create
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Rebuild(It.IsAny<Models.Vat.EditViewModel>())).Returns(new Models.Vat.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Create VAT Code", namedArgument.TypedValue.Value);
        }
