...
namespace Admin.UnitTests.Controllers.Vat.Create
{
    [TestClass]
    ...
    public class Post
    {
        ...
        {
            var createCommand = new Mock<IModelCommand<Models.Vat.EditViewModel>>();
            createCommand.Setup(x => x.Execute(It.IsAny<Models.Vat.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
