...
namespace Admin.UnitTests.Controllers.Vat.Details
{
    [TestClass]
    ...
    public class Get
    {
        ...
        {
            var detailsViewModelBuilder = new Mock<IModelBuilder<Models.Vat.DetailsViewModel, string>>();
            detailsViewModelBuilder.Setup(x => x.Build(It.IsAny<string>())).Returns(new Models.Vat.DetailsViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("VAT Code Details", namedArgument.TypedValue.Value);
        }
        ...
        public void ReturnsCorrectViewModelType()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(Models.Vat.DetailsViewModel));
        }
    }
}
