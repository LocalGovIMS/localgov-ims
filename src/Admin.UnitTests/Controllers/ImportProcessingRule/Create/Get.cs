...
namespace Admin.UnitTests.Controllers.ImportProcessingRule.Create
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Build()).Returns(new Models.ImportProcessingRule.EditViewModel());
            MockEditViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.ImportProcessingRule.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Create Rule", namedArgument.TypedValue.Value);
        }
