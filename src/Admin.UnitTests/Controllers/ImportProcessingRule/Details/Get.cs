...
namespace Admin.UnitTests.Controllers.ImportProcessingRule.Details
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockDetailsViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.ImportProcessingRule.DetailsViewModel());
        ...
        public void ReturnsCorrectViewModelType()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(Models.ImportProcessingRule.DetailsViewModel));
        }
    }
}
