...
namespace Admin.UnitTests.Controllers.ImportProcessingRuleAction.Create
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockCreateViewModelBuilder.Setup(x => x.Build()).Returns(new Models.ImportProcessingRuleAction.EditViewModel());
            MockCreateViewModelBuilder.Setup(x => x.Build(It.IsAny<CreateViewModelBuilderArgs>())).Returns(new Models.ImportProcessingRuleAction.EditViewModel());
