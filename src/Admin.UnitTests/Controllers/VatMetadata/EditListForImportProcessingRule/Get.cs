...
using Controller = Admin.Controllers.VatMetadataController;
using ControllerDependencies = Admin.Controllers.VatMetadataControllerDependencies;
using DetailsViewModel = Admin.Models.VatMetadata.DetailsViewModel;
using EditViewModel = Admin.Models.VatMetadata.EditViewModel;
using ListViewModel = Admin.Models.VatMetadata.ListViewModel;
using SearchCriteria = Admin.Models.VatMetadata.SearchCriteria;

namespace Admin.UnitTests.Controllers.VatMetadata.EditListForImportProcessingRule
{
    [TestClass]
    ...
    public class Get
    {
        ...
        private MethodInfo GetListMethod()
        {
            return _controller.GetMethods()
                .Where(x => x.Name == "_EditListForVat")
                .FirstOrDefault();
        }
        ...
        private ActionResult GetTestListResult()
        {
            ...
            return controller._EditListForVat("1");
        }
