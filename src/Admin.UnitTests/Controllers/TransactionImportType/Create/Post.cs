...
namespace Admin.UnitTests.Controllers.TransactionImportType.Create
{
    [TestClass]
    ...
    public class Post
    {
        ...
        {
            var createCommand = new Mock<IModelCommand<Models.TransactionImportType.EditViewModel>>();
            createCommand.Setup(x => x.Execute(It.IsAny<Models.TransactionImportType.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
