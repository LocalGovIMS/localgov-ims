...
namespace Admin.UnitTests.Controllers.FundGroup.Create
{
    ...
    public class Get
    {
        ...
        {
            var createViewModelBuilder = new Mock<IModelBuilder<Models.FundGroup.EditViewModel, int>>();
            createViewModelBuilder.Setup(x => x.Build()).Returns(new Models.FundGroup.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Create Fund Group", namedArgument.TypedValue.Value);
        }
