...
namespace Admin.UnitTests.Controllers.FundGroup.Edit
{
    ...
    public class Post
    {
        ...
        {
            var editCommand = new Mock<IModelCommand<Models.FundGroup.EditViewModel>>();
            editCommand.Setup(x => x.Execute(It.IsAny<Models.FundGroup.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
