...
namespace Admin.UnitTests.Controllers.MetadataKey.Details
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        {
            MockDetailsViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.MetadataKey.DetailsViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Metadata Key Details", namedArgument.TypedValue.Value);
        }
        ...
        public void ReturnsCorrectViewModelType()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(Models.MetadataKey.DetailsViewModel));
        }
    }
}
