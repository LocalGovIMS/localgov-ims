...
namespace Admin.UnitTests.Controllers.MetadataKey.Create
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Rebuild(It.IsAny<Models.MetadataKey.EditViewModel>())).Returns(new Models.MetadataKey.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Create Metadata Key", namedArgument.TypedValue.Value);
        }
