...
namespace Admin.UnitTests.Controllers.MetadataKey.List
{
    [TestClass]
    ...
    public class Get : BaseTest
    {
        ...
        {
            MockListViewModelBuilder.Setup(x => x.Build()).Returns(new Models.MetadataKey.ListViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Metadata Keys", namedArgument.TypedValue.Value);
        }
        ...
        public void ReturnsCorrectViewModelType()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(Models.MetadataKey.ListViewModel));
        }
    }
}
