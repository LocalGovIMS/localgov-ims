...
namespace Admin.UnitTests.Controllers.MetadataKey.Edit
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.MetadataKey.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Edit Metadata Key", namedArgument.TypedValue.Value);
        }
