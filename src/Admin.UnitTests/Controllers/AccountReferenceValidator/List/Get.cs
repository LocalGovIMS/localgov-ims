...
namespace Admin.UnitTests.Controllers.AccountReferenceValidator.List
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Account Reference Validators", namedArgument.TypedValue.Value);
        }
        ...
        public void ReturnsCorrectViewModelType()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(Models.AccountReferenceValidator.ListViewModel));
        }
    }
}
