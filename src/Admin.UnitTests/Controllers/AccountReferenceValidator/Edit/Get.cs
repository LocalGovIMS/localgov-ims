...
namespace Admin.UnitTests.Controllers.AccountReferenceValidator.Edit
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.AccountReferenceValidator.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Edit Validator", namedArgument.TypedValue.Value);
        }
