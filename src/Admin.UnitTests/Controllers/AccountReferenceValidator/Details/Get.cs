...
namespace Admin.UnitTests.Controllers.AccountReferenceValidator.Details
{
    [TestClass]
    ...
    public class Get
    {
        ...
        {
            var detailsViewModelBuilder = new Mock<IModelBuilder<Models.AccountReferenceValidator.DetailsViewModel, int>>();
            detailsViewModelBuilder.Setup(x => x.Build(It.IsAny<int>())).Returns(new Models.AccountReferenceValidator.DetailsViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Validator Details", namedArgument.TypedValue.Value);
        }
        ...
        public void ReturnsCorrectViewModelType()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(Models.AccountReferenceValidator.DetailsViewModel));
        }
    }
}
