...
namespace Admin.UnitTests.Controllers.AccountReferenceValidator.Create
{
    ...
    public class Post
    {
        ...
        {
            var createCommand = new Mock<IModelCommand<Models.AccountReferenceValidator.EditViewModel>>();
            createCommand.Setup(x => x.Execute(It.IsAny<Models.AccountReferenceValidator.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
