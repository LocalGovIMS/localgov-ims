...
namespace Admin.UnitTests.Controllers.EReturnNote.Create
{
    ...
    public class Post : TestBase
    {
        ...
        private ActionResult GetResult(Models.EReturnNote.EditViewModel model, bool isModelValid)
        {
            MockCreateCommand.Setup(x => x.Execute(It.IsAny<Models.EReturnNote.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
        ...
        {
            var result = GetResult(new Models.EReturnNote.EditViewModel(), false) as ViewResult;
        ...
        public void ReturnsCorrectViewModelTypeIfModelInvalid()
        {
            ...
            Assert.IsNotNull(result);
            Assert.IsInstanceOfType(result.Model, typeof(Models.EReturnNote.EditViewModel));
        }

        [TestMethod]
        public void ReturnsRedirectToRouteResultIfModelValid()
        {
            var result = GetResult(new Models.EReturnNote.EditViewModel(), true);
        ...
        {
            var result = GetResult(new Models.EReturnNote.EditViewModel(), true) as RedirectToRouteResult;
