...
namespace Admin.UnitTests.Controllers.FundMessageMetadata.EditListForFundMessage
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        {
            return GetMethod(typeof(ChildActionOnlyAttribute), nameof(Controller._EditListForFundMessage));
        }
        ...
        {
            MockListViewModelBuilder.Setup(x => x.Build(It.IsAny<Models.FundMessageMetadata.SearchCriteria>())).Returns(new Models.FundMessageMetadata.ListViewModel());

            return Controller._EditListForFundMessage(1);
        }
