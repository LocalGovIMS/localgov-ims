...
namespace Admin.UnitTests.Controllers.CheckDigitConfiguration.Create
{
    [TestClass]
    ...
    public class Post
    {
        ...
        {
            var createCommand = new Mock<IModelCommand<Models.CheckDigitConfiguration.EditViewModel>>();
            createCommand.Setup(x => x.Execute(It.IsAny<Models.CheckDigitConfiguration.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
