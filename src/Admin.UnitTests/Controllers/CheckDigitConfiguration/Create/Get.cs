...
namespace Admin.UnitTests.Controllers.CheckDigitConfiguration.Create
{
    ...
    public class Get : TestBase
    {
        ...
        {
            MockEditViewModelBuilder.Setup(x => x.Build()).Returns(new Models.CheckDigitConfiguration.EditViewModel());
        ...
        public void NavigatablePageActionFilterAttributeHasCorrectDisplayText()
        {
            ...
            Assert.AreEqual("Create Configuration", namedArgument.TypedValue.Value);
        }
