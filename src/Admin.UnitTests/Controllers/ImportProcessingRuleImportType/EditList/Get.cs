...
namespace Admin.UnitTests.Controllers.ImportProcessingRuleImportType.EditList
{
    [TestClass]
    ...
    public class Get : TestBase
    {
        ...
        {
            return GetMethod(typeof(ChildActionOnlyAttribute), nameof(Controller._EditList));
        }
