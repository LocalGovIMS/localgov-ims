...
namespace Admin.UnitTests.Controllers.FundMessage.Edit
{
    ...
    public class Post
    {
        ...
        {
            var editCommand = new Mock<IModelCommand<Models.FundMessage.EditViewModel>>();
            editCommand.Setup(x => x.Execute(It.IsAny<Models.FundMessage.EditViewModel>())).Returns(new Admin.Classes.Commands.CommandResult(true));
