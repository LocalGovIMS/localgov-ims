...
namespace Admin.UnitTests.Controllers.TransactionImportTypeImportProcessingRule.Delete
{
    [TestClass]
    ...
    public class Get
    {
        ...
        public void RedirectsToTheCorrectController()
        {
            ...
            Assert.AreEqual(result.RouteValues["controller"], "TransactionImportType");
        }
