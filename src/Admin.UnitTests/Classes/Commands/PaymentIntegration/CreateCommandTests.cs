...
using Command = Admin.Classes.Commands.PaymentIntegration.CreateCommand;
...
namespace Admin.UnitTests.Classes.Commands.PaymentIntegration
{
    ...
    public class CreateCommandTests
    {
        ...
        {
            // Arrange
            _mockPaymentIntegrationService.Setup(x => x.Update(It.IsAny<BusinessLogic.Entities.PaymentIntegration>()))
                .Returns(new Result());
