...
using Command = Admin.Classes.Commands.MethodOfPaymentMetadata.DeleteCommand;
...
namespace Admin.UnitTests.Classes.Commands.MethodOfPaymentMetadata
{
    ...
    public class DeleteCommandTests
    {
        ...
        public void Execute_calls_ImportProcessingRuleService_Create_method_once()
        {
            ...
            // Assert
            _mockMethodOfPaymentMetadataService.Verify(x => x.Delete(It.IsAny<int>()), Times.Once);
        }
    }
}
