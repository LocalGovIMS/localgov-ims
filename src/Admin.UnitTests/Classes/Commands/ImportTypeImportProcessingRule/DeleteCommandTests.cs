...
using Command = Admin.Classes.Commands.ImportTypeImportProcessingRule.DeleteCommand;
...
namespace Admin.UnitTests.Classes.Commands.ImportTypeImportProcessingRule
{
    ...
    public class DeleteCommandTests
    {
        ...
        public void Execute_returns_expected_result()
        {
            ...
            _mockImportTypeImportProcessingRuleService.Setup(x => x.Delete(It.IsAny<int>()))
