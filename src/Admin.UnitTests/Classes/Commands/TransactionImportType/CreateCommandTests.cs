...
using Command = Admin.Classes.Commands.TransactionImportType.CreateCommand;
...
namespace Admin.UnitTests.Classes.Commands.TransactionImportType
{
    ...
    public class CreateCommandTests
    {
        ...
        [TestMethod]
        public void Execute_calls_TransactionImportTypeService_Create_method_once()
        {
            // Arrange
            var command = new Command(
                _mockLogger.Object,
            ...
            // Assert
            _mockTransactionImportTypeService.Verify(x => x.Create(It.IsAny<BusinessLogic.Entities.TransactionImportType>()), Times.Once);
        }
    }
}
