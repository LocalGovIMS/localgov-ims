...
using System.Web;
using Command = Admin.Classes.Commands.Import.SaveImportFileCommand;
using CommandArgs = Admin.Classes.Commands.Import.SaveImportFileCommandArgs;
...
namespace Admin.UnitTests.Classes.Commands.Import
{
    ...
    public class SaveImportFileCommandTests
    {
        ...
        public SaveImportFileCommandTests()
        {
            ...
            _mockImportService.Setup(x => x.LoadFromFile(It.IsAny<string>()))
        ...
        [TestMethod]
        public void ImportService_LoadFromFile_method_is_called_once()
        {
            // Arrange
            var args = GenerateArgs();
            var command = CrateCommand();
            ...
            // Assert
            _mockImportService.Verify(x => x.LoadFromFile(It.IsAny<string>()), Times.Once);
        }
        ...
        [TestMethod]
        public void When_ImportService_LoadFromFile_returns_no_data_the_expected_error_message_is_returned()
        {
            // Arrange
            var args = GenerateArgs();
            var command = CrateCommand();
        ...
        [TestMethod]
        public void When_ImportService_LoadFromFile_returns_no_data_in_an_unexpected_format_the_expected_error_message_is_returned()
        {
            // Arrange
            var args = GenerateArgs();
            var command = CrateCommand();
