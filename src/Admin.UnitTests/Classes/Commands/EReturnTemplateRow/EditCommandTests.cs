...
using Command = Admin.Classes.Commands.EReturnTemplateRow.EditCommand;
...
namespace Admin.UnitTests.Classes.Commands.EReturnTemplateRow
{
    ...
    public class EditCommandTests
    {
        ...
        public void Execute_calls_ImportProcessingRuleService_Update_method_once()
        {
            ...
            // Assert
            _mockEReturnTemplateRowService.Verify(x => x.Update(It.IsAny<BusinessLogic.Entities.TemplateRow>()), Times.Once);
        }
    }
}
