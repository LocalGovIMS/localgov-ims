...
using Command = Admin.Classes.Commands.Suspense.JournalCommand;
...
namespace Admin.UnitTests.Classes.Commands.Suspense
{
    ...
    public class JournalCommandTests
    {
        ...
        {
            service.Setup(x => x.Journal(
                It.IsAny<List<int>>(),
                It.IsAny<List<BusinessLogic.Models.Suspense.Journal>>(),
                It.IsAny<List<BusinessLogic.Models.Suspense.CreditNote>>())).Returns(new Result());
        }
