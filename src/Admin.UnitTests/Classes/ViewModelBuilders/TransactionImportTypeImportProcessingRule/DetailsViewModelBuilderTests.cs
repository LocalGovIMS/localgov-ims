...
using Moq;
using ViewModel = Admin.Models.TransactionImportTypeImportProcessingRule.DetailsViewModel;
using ViewModelBuilder = Admin.Classes.ViewModelBuilders.TransactionImportTypeImportProcessingRule.DetailsViewModelBuilder;
