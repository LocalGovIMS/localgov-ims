...
using Moq;
using ViewModel = Admin.Models.ImportProcessingRuleImportType.DetailsViewModel;
using ViewModelBuilder = Admin.Classes.ViewModelBuilders.ImportProcessingRuleImportType.DetailsViewModelBuilder;
