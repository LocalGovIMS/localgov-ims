...
using ViewModel = Admin.Models.TransactionImportType.DetailsViewModel;
using ViewModelBuilder = Admin.Classes.ViewModelBuilders.TransactionImportType.DetailsViewModelBuilder;
...
namespace Admin.UnitTests.Classes.ViewModelBuilders.TransactionImportType
{
    ...
    public class DetailsViewModelBuilderTests
    {
        ...
        {
            _mockTransactionImportTypeService.Setup(x => x.Get(It.IsAny<int>())).Returns(
