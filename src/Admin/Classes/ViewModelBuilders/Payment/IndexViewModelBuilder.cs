...
namespace Admin.Classes.ViewModelBuilders.Payment
{
    public class IndexViewModelBuilder : BaseViewModelBuilder<IndexViewModel, IndexViewModel>
    {
        ...
        private readonly IUserMopCodeService _userMopCodeService;
        private readonly ISecurityContext _securityContext;

        public IndexViewModelBuilder(ILog log
            , IFundService fundService
            , IVatService vatService
            , IUserMopCodeService userPostPaymentMopCodeService
            , ISecurityContext securityContext) :
            base(log)
        {
            _fundService = fundService;
            _vatService = vatService;
            _userMopCodeService = userPostPaymentMopCodeService;
        ...
        protected override IndexViewModel OnBuild()
        {
            ...
            var mopCodes = _userMopCodeService.GetByUserId(_securityContext.UserId).OrderBy(x => x.MopCode);
        ...
        private SelectList GetMopCodeList(IOrderedEnumerable<UserMopCode> mopCodes)
        {
            ...
            {
                var mop = _userMopCodeService.GetDefaultUserMopCode();
