...
namespace Admin.Classes.ViewModelBuilders.Transfer
{
    public class TransferViewModelBuilder : BaseViewModelBuilder<TransferViewModel, string>
    {
        ...
        // HIGH: What's going on here - why do both methods return the same data, even though one accepts some criteria?
