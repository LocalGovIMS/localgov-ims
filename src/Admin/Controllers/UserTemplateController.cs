...
namespace Admin.Controllers
{
    ...
    public class UserTemplateController : BaseController<IUserTemplateControllerDependencies>
    {
        public UserTemplateController(IUserTemplateControllerDependencies dependencies)
            : base(dependencies)
        {
        }
