...
{
    public class FundMetadataControllerDependencies : BaseControllerDependencies, IFundMetadataControllerDependencies
    {
        public FundMetadataControllerDependencies(
            ILog log
            ...
            , [Dependency("FundMetadata.Command.Delete")] IModelCommand<int> deleteCommand
            )
             : base(log)
        {
