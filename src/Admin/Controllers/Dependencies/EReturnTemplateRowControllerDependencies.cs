...
{
    public class EReturnTemplateRowControllerDependencies : BaseControllerDependencies, IEReturnTemplateRowControllerDependencies
    {
        public EReturnTemplateRowControllerDependencies(
            ILog log
            ...
            , [Dependency("EReturnTemplateRow.Command.Delete")] IModelCommand<int> deleteCommand
            )
             : base(log)
        {
