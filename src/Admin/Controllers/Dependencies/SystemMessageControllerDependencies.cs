...
{
    public class SystemMessageControllerDependencies : BaseControllerDependencies, ISystemMessageControllerDependencies
    {
        public SystemMessageControllerDependencies(
            ILog log
