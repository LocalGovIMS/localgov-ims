...
{
    public class ImportProcessingRuleConditionControllerDependencies : BaseControllerDependencies, IImportProcessingRuleConditionControllerDependencies
    {
        public ImportProcessingRuleConditionControllerDependencies(
            ILog log
            ...
            , [Dependency("ImportProcessingRuleCondition.Command.Delete")] IModelCommand<int> deleteCommand
            )
             : base(log)
        {
