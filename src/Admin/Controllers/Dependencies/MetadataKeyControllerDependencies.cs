...
{
    public class MetadataKeyControllerDependencies : BaseControllerDependencies, IMetadataKeyControllerDependencies
    {
        public MetadataKeyControllerDependencies(
            ILog log
            ...
            , [Dependency("MetadataKey.Command.Delete")] IModelCommand<int> deleteCommand)
             : base(log)
        {
