...
{
    public class ImportTypeImportProcessingRuleControllerDependencies : BaseControllerDependencies, IImportTypeImportProcessingRuleControllerDependencies
    {
        public ImportTypeImportProcessingRuleControllerDependencies(
            ILog log
            ...
            , [Dependency("ImportTypeImportProcessingRule.Command.Delete")] IModelCommand<int> deleteCommand
            )
             : base(log)
        {
