...
{
    public class ImportProcessingRuleImportTypeControllerDependencies : BaseControllerDependencies, IImportProcessingRuleImportTypeControllerDependencies
    {
        public ImportProcessingRuleImportTypeControllerDependencies(
            ILog log
            ...
            , [Dependency("ImportProcessingRuleImportType.Command.Delete")] IModelCommand<int> deleteCommand
            )
             : base(log)
        {
