...
{
    public class TransactionImportTypeImportProcessingRuleControllerDependencies : BaseControllerDependencies, ITransactionImportTypeImportProcessingRuleControllerDependencies
    {
        public TransactionImportTypeImportProcessingRuleControllerDependencies(
            ILog log
            ...
            , [Dependency("TransactionImportTypeImportProcessingRule.Command.Delete")] IModelCommand<int> deleteCommand
            )
             : base(log)
        {
