...
{
    public class FundMessageMetadataControllerDependencies : BaseControllerDependencies, IFundMessageMetadataControllerDependencies
    {
        public FundMessageMetadataControllerDependencies(
            ILog log
            ...
            , [Dependency("FundMessageMetadata.Command.Delete")] IModelCommand<int> deleteCommand
            )
             : base(log)
        {
