...
{
    public class EReturnTemplateControllerDependencies : BaseControllerDependencies, IEReturnTemplateControllerDependencies
    {
        public EReturnTemplateControllerDependencies(
            ILog log
