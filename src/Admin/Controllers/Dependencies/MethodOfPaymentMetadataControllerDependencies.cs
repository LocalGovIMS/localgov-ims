...
{
    public class MethodOfPaymentMetadataControllerDependencies : BaseControllerDependencies, IMethodOfPaymentMetadataControllerDependencies
    {
        public MethodOfPaymentMetadataControllerDependencies(
            ILog log
            ...
            , [Dependency("MethodOfPaymentMetadata.Command.Delete")] IModelCommand<int> deleteCommand
            )
             : base(log)
        {
