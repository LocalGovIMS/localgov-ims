...
{
    public class MethodOfPaymentControllerDependencies : BaseControllerDependencies, IMethodOfPaymentControllerDependencies
    {
        public MethodOfPaymentControllerDependencies(
            ILog log
