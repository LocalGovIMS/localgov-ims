...
{
    public class TransactionImportTypeControllerDependencies : BaseControllerDependencies, ITransactionImportTypeControllerDependencies
    {
        public TransactionImportTypeControllerDependencies(
            ILog log
