...
{
    public class CheckDigitConfigurationControllerDependencies : BaseControllerDependencies, ICheckDigitConfigurationControllerDependencies
    {
        public CheckDigitConfigurationControllerDependencies(
            ILog log
            ...
            , [Dependency("CheckDigitConfiguration.Command.Delete")] IModelCommand<int> deleteCommand)
             : base(log)
        {
